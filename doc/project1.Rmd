...
folder.path="C:/Users/Simon/Documents/GitHub/Spr2017-Proj1-zhuuu/data/InauguralSpeeches/"
...
```{r,echo = FALSE}
sentence.list<-read.csv("C:/Users/Simon/Documents/GitHub/Spr2017-Proj1-zhuuu/data/sen.csv",header = T)
...
sentence.list1<-rbind(sentence.list,BarackObama.sentence.list)
```
...
No pattern can be find here, but president Obama and Roosevelt are closer to each other compare to Turman.
...
This the plot cluster by the setiment of *positive* and *negative*.
\newline\
Again, no pattern can be find here, president Obama and Roosevelt are closer to each other compare to Turman.
